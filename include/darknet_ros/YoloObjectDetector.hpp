...
class YoloObjectDetector : public rclcpp::Node
{
 ...
 private:
  ...
  //tambahan
  rclcpp::Publisher<std_msgs::msg::Int32MultiArray>::SharedPtr barelangPublisher_;
  ...
  // tambahan
  std_msgs::msg::Int32MultiArray barelangResults_;
  ...
  int ball_x_, ball_y_, goal_x_, goal_y_;
